function vasDrawJNDResults(JNDa, saveResultsDir, allRunData)
...
%     title(['f0 Acuity JND ' num2str(ii) ': ' revNote triNote timNote], 'FontSize', titleFS, 'FontName', 'Arial', 'FontWeight', 'bold')
    ...
    ylabel('Relative Formant Continuum Distance (-)','FontSize', xyFS,'FontName','Arial', 'FontWeight', 'bold');
    axis([0 100 0 100])
...
suptitle({'Formant Frequency Acuity JND', JNDa.participant, ['JND Score: ' num2str(JNDa.JNDScoreMean) ' Steps']})
