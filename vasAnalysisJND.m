...
% vasAnalysisJND() loads a Formant Acuity JND data set (FA#DRF.mat) and analyzed the raw
...
for ii = JNDa.runs2Analyze 
    ...
    dirs.SavFileDir  = fullfile(dirs.RecData, JNDa.participant, curRun, [JNDa.participant curRun 'DRF.mat']); %Where to find data
    ...
    [JNDScore, lastSetAccu] = vasAnalyzeThresholdJND(UD, 'reversals', 4); %Cents
...
vasDrawJNDResults(JNDa, dirs.SavResultsDir, allJNDData)
end
